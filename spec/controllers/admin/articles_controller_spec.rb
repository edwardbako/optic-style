  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Article" do
        expect {
          post :create, params: {admin_article: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {admin_article: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_article" do
        article = Admin::Article.create! valid_attributes
        put :update, params: {id: article.to_param, admin_article: new_attributes}, session: valid_session
        article.reload
      ...
      it "redirects to the admin_article" do
        article = Admin::Article.create! valid_attributes
        put :update, params: {id: article.to_param, admin_article: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        article = Admin::Article.create! valid_attributes
        put :update, params: {id: article.to_param, admin_article: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
